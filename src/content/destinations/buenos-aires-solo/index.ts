 ...
 * ============================================================
 *
 *  ARQUIVO: src/content/destinations/buenos-aires-solo/index.ts
 *  DESTINO: Buenos Aires, Argentina
 *  SLUG: buenos-aires-solo
 *  URL: /#/destino/buenos-aires-solo
 *
 *  MAPA DE EDICAO:
 *  +------------------+----------------------------+----------+
...
const content: DestinationContent = {
  ...
  es: {
    ...
    introText:
      'Bienvenido a la pagina de Buenos Aires. Descubre por que este destino es perfecto para tu proximo viaje.',
    description: '',
    tips: [],
    bestSeason: '',
    metaDescription:
  ...
  pt: {
    ...
    introText:
      'Bem-vindo a pagina de Buenos Aires. Descubra por que este destino e perfeito para sua proxima viagem.',
    description: '',
    tips: [],
    bestSeason: '',
    metaDescription:
  ...
  en: {
    ...
    introText:
      'Welcome to the Buenos Aires page. Discover why this destination is perfect for your next trip.',
    description: '',
    tips: [],
    bestSeason: '',
    metaDescription:
